...
<body id="body-<?php echo $section; ?>" onload="<?php echo $onload; ?>">
	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<p>If you seek elections which involved specific people, issues, or parties, use the Advanced search filters. Your results will display in a list of election profile links. As always, you may click the country name to go directly to the country profile page.  For multiple selections hold down the control key and click the mouse to highlight each of your choices. The more criteria you choose, the narrower your search will be; for more results, reduce the number of filters used.</p>
			</td>
