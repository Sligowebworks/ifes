...
<body id="body-<?php echo $section; ?>" onload="<?php echo $onload; ?>">
	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<h2>Government Structure: Chiefs of State </h2>
			<p>View ways in which Chiefs of State obtain office; search by country,
            region, methods of election, appointment, etc. of offices, and date.</p>

                <form action="reports6.php" method="get">
