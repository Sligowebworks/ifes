...
<body id="body-<?php echo $section; ?>">
	...
	<div id="wrapper">
		...
		<img align="right" src="images/ads/samplead.jpg" /> 
				...
				<p>Election Guide is provided by IFES, an international nonprofit dedicated to the building of democratic societies. Launched in 1998 through a generous grant from USAID, ElectionGuide is the most comprehensive and timely source of verified election information and results available online. Its content is also available on <a href="http://www.cnn.com/WORLD/election.watch/" target="_blank">CNN Election Watch</a>.</p>
				...
				<p>IFES' F. Clifton White Applied  Research Center on Democracy and Elections (ARC) houses the Election Guide research team, who are responsible for gathering the data, analyzing the results, writing reports and maintaining the consistency and accuracy of ElectionGuide.</p>
