	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			<div id="content-wrapper">
				...
				<!-- Ads come here -->
		<img align="right" src="images/ads/samplead.jpg" /> <br /><br /> <br />
				...
				<p>Explore our Search and Reporting features here. Please use the
                Quick Search console on the left to search quickly for election
                profiles.  Use the drop down menus to define your search criteria.
                Your search results will be listed on this page.</p>

                <p>For more options and filters, please go to the Advanced Search
                page to seek elections that fit your criteria.  To generate comparative
                charts and reports, please go to the Reports page. </p>
