	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			<div id="content-wrapper">
				...
				<h3>Finding Information on the Site</h3> <br>
				<p><strong>Country Profiles </strong> can be accessed through country names and flags which link to the Country Profile pages.  Former countries or former names of existing countries may not have active Country Profile pages.  This means that the country name may be visible on a Region Page, but not linked.  The past election profiles will still be linked and visible by looking at the Calendar, or by using the Quick Search, Advanced Search, or Reports. </p>  
				<p><strong>Election Profiles </strong> are linked from election type names or dates.  We post profiles approximately two weeks before an election date.  If an Election Date is known, but has not yet been profiled, the date and election type will be visible on the Calendar and in Searches, but the type name will not be an active link.  Some past elections may also be missing profiles and filling in information is an ongoing process.</p>
				<p><strong>Region Pages</strong> can be accessed through the Map, the Country Profile, the Advanced Search, or certain Reports.  Region pages list all countries and territories within the Region and show upcoming elections, related news, past elections, and links.

								
				
				<h3>Identifying Election Dates</h3><br>
				...
				<h3>Compiling Election Profiles</h3> <br>
				...
				<h3>Verifying Information</h3> <br>
