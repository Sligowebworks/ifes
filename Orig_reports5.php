...
<body id="body-<?php echo $section; ?>" onload="<?php echo $onload; ?>">
	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<p>View ways in which Assembly members obtain office; search by country,
            region, methods of election, appointment, etc. of offices, and date. This
            report allows you to compare the ways in which presidents.</p>
