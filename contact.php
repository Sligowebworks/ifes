	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<!-- AD ends here-->
				...
				<h2>Contact Us:</h2>
				<p>We are very interested in feedback and questions about ElectionGuide as we strive to keep our information clear and up to date.</p>

				<p>Please contact electionguide [at] ifes [dot] org, and we will respond shortly.</p>
                
		<!-- Begin disabling of comment form by JS on 23 June 2009 -->
                <!-- <p>* Required field</p>
                <?php
		...
		<!-- End disabling of comment form on 23 June 2009 by JS -->
			</div>
			<hr />
