	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			<div id="content-wrapper">
				<h2>ElectionGuide:</h2>
				<p>ElectionGuide provides information on national elections around the world with coverage beginning in 1998. Move your mouse over the dots below to view the next 10 election dates or click a region to view a Region page. ElectionGuide is a product of the <a href="http://www.ifes.org/arc.html" target="_blank" style="color:black">F. Clifton White Applied Research Center</a>.</p>
