		...
		<div id="main-wrapper">
			<div id="content-wrapper">
			 <?php include( "includes/nav-search.php" ); ?>
                ...
                Each report is summarized below - the report pages describe the results set you will receive in detail.
				Only Election Profiles with results posted will be returned in Reports.</p>
                
				<ul>
                    <li><a href="reports1.php">Voter Turnout</a> - Choose your date range to display and compare turnout statistics by country or region.</li>
                    <li><a href="reports4.php">Average Voter Turnout</a> - Choose a region and date range to view average turnout by region for each election type. </li>
                    ...
                    <li><a href="reports3.php">Presidential Candidate Performance</a> - View candidates, votes, and change in votes over time; search by country, region, candidate name, candidate party, and date.</li>
                    <li><a href="reports5.php">Government Structure: Assemblies</a> - View ways in which Assembly members obtain office; search by country, region, methods of election, appointment, etc. of offices, and date. </li>
