...
<body id="body-<?php echo $section; ?>" onload="<?php echo $onload; ?>">
	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<p>This report lists the winning presidential candidates for specific elections. Select criteria below to narrow your search by 
			country, year, date, etc. Only Election Profiles with results posted will be returned in Reports.</p>
			</td>
