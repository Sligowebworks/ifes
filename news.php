	...
	<div id="wrapper">
		...
		<div id="main-wrapper">
			...
			<!-- AD ends here-->
				...
				//echo "<textarea style='width: 100%; height: 400px;'>".$status->saveXML()."</textarea>";
                ...
                for($x=0;$x<$ctr;$x++) {
					...
					else if ( strstr($values[$x]['link'], "news_item.php")) 
					{  
                        echo '<a href="'.$values[$x]['link'].'">Read full story</a>.';
					}
					else
					{
